...
export const previewProjects: Record<string, IPreviewProject> = {
  ...
  PEd7uyHaUP: {
    slug: "nounout",
    projectName: "Nounout",
    logo: "/preview/nounout/logo.jpg",
    contactName: "L'équipe Nounout",
    currentRound: "V1",
    nextAction: "Premier contact, en attente de retour",
    feedbackFormId: "xgoggnej",
    coldIntro:
    ...
    rounds: [
      {
        ...
        date: "31 août 2026",
        proposals: [
          { label: "Votre site, premier jet", screenshot: "/preview/nounout/logo.jpg", htmlPath: "/preview/nounout/PEd7uyHaUP/V1/P1" },
        ],
        missingInfo: ["Votre avis sur cette première version, ou tout élément à corriger"],
      },
    ],
  ...
  nXik5p9XUl: {
    slug: "moussa-boxe-thai",
    projectName: "My Coach Moussa",
    logo: "/preview/moussa-boxe-thai/logo.png",
    contactName: "Moussa",
    currentRound: "V1",
    nextAction: "Premier contact, en attente de retour",
    feedbackFormId: "xgoggnej",
    ...
    rounds: [
      {
        ...
        date: "31 août 2026",
        proposals: [
          { label: "Votre site, premier jet", screenshot: "/preview/moussa-boxe-thai/logo.png", htmlPath: "/preview/moussa-boxe-thai/nXik5p9XUl/V1/P1" },
        ],
        missingInfo: ["Votre avis sur cette première version, ou tout élément à corriger"],
      },
    ],
