...
export default function ArticleSidebar({ articles, activeSlug }: IArticleSidebarProps) {
  ...
  return (
    <aside className="hidden md:flex flex-col w-64 shrink-0 fixed top-[82px] left-0 h-[calc(100vh-82px)] overflow-y-auto border-r border-border bg-background py-8 px-4 gap-6">
      {/* Tag filters */}
      <div>
