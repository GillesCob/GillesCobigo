    ...
    <nav className="fixed top-0 left-0 w-full z-50 bg-[#0A0A0A] border-b border-white/10">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          <div className="hidden md:flex items-center gap-6">
            <Link to="/projects" className="text-white/70 hover:text-white text-sm transition-colors">
              Projets
            </Link>
            <Link to="/articles" className="text-white/70 hover:text-white text-sm transition-colors">
              Articles
            </Link>
      ...
      {mobileOpen && (
        <div className="md:hidden bg-[#0A0A0A] border-t border-white/10 px-4 py-4 flex flex-col gap-4">
          <Link to="/projects" className="text-white/80 hover:text-white" onClick={() => setMobileOpen(false)}>
            Projets
          </Link>
          <Link to="/articles" className="text-white/80 hover:text-white" onClick={() => setMobileOpen(false)}>
            Articles
          </Link>
          <Link to="/contact" className="text-white/80 hover:text-white" onClick={() => setMobileOpen(false)}>
            Contact
          </Link>
